...
![Project Banner](https://github.com/YourUsername/Bank_Analytics/blob/main/images/banner.png)  
...
- **Loan Dataset** – Kaggle (Bank Loan Applications)  
- **Credit Card Transactions Dataset** – Transactions & fraud detection data  
...
![Loan Applications](https://github.com/YourUsername/Bank_Analytics/blob/main/images/loan_count.png)  

---

### 2. Loan Approval vs Rejection  
**Query:** Compare approved and rejected loans.  
![Loan Status](https://github.com/YourUsername/Bank_Analytics/blob/main/images/loan_status.png)  

---

### 3. Average Applicant Income  
**Query:** Find average applicant income across dataset.  
![Average Income](https://github.com/YourUsername/Bank_Analytics/blob/main/images/avg_income.png)  

---

### 4. Average Credit Score  
**Query:** Calculate average credit score of applicants.  
![Average Credit Score](https://github.com/YourUsername/Bank_Analytics/blob/main/images/avg_credit_score.png)  

---

### 5. Loans by Gender  
**Query:** Analyze loan distribution by gender.  
![Loans by Gender](https://github.com/YourUsername/Bank_Analytics/blob/main/images/loans_gender.png)  

---

### 6. Loans by Occupation  
**Query:** Breakdown of loans across different occupations.  
![Loans by Occupation](https://github.com/YourUsername/Bank_Analytics/blob/main/images/loans_occupation.png)  

---

### 7. Loans by Education Level  
**Query:** Distribution of loans by education qualification.  
![Loans by Education](https://github.com/YourUsername/Bank_Analytics/blob/main/images/loans_education.png)  

---

### 8. Loan Approval Rate by Gender  
**Query:** Approved vs rejected loans based on gender.  
![Approval by Gender](https://github.com/YourUsername/Bank_Analytics/blob/main/images/approval_gender.png)  

---

### 9. Loan Approval Rate by Occupation  
**Query:** Approval rates across different job categories.  
![Approval by Occupation](https://github.com/YourUsername/Bank_Analytics/blob/main/images/approval_occupation.png)  

---

### 10. Loan Approval Rate by Education Level  
**Query:** Loan approvals vs rejections by education.  
![Approval by Education](https://github.com/YourUsername/Bank_Analytics/blob/main/images/approval_education.png)  

---

### 11. Loan Approval Rate by Marital Status  
**Query:** Approved vs rejected loans for married vs single applicants.  
![Approval by Marital Status](https://github.com/YourUsername/Bank_Analytics/blob/main/images/approval_marital.png)  

---

### 12. Top 5 High Income Approved Applicants  
**Query:** Find top 5 highest income applicants with approved loans.  
![Top Income Applicants](https://github.com/YourUsername/Bank_Analytics/blob/main/images/top_income.png)  

---

### 13. Total Credit Card Transactions  
**Query:** Count total number of credit card transactions.  
![Total Transactions](https://github.com/YourUsername/Bank_Analytics/blob/main/images/total_transactions.png)  

---

### 14. Fraudulent vs Non-Fraudulent Transactions  
**Query:** Fraud detection analysis.  
![Fraud Analysis](https://github.com/YourUsername/Bank_Analytics/blob/main/images/fraud_vs_nonfraud.png)  

---

### 15. Fraud vs Non-Fraud Transaction Amounts  
**Query:** Total transaction amounts comparison.  
![Fraud Amount](https://github.com/YourUsername/Bank_Analytics/blob/main/images/fraud_amount.png)  

---

### 16. Top 5 Merchants with Most Transactions  
**Query:** Find merchants with the highest number of transactions.  
![Top Merchants](https://github.com/YourUsername/Bank_Analytics/blob/main/images/top_merchants.png)  

---

### 17. Average Transaction Amount (Fraud vs Non-Fraud)  
**Query:** Compare fraud and non-fraud average transaction size.  
![Avg Transaction](https://github.com/YourUsername/Bank_Analytics/blob/main/images/avg_transaction.png)  

---

### 18. Transaction Distribution by Category  
**Query:** Count transactions by category.  
![Category Transactions](https://github.com/YourUsername/Bank_Analytics/blob/main/images/category_distribution.png)  

---

### 19. Customers with Highest Number of Transactions  
**Query:** Top customers by transaction frequency.  
![Top Customers](https://github.com/YourUsername/Bank_Analytics/blob/main/images/top_customers.png)  

---

### 20. Monthly Transaction Trends  
**Query:** Analyze transaction activity month-wise.  
![Monthly Transactions](https://github.com/YourUsername/Bank_Analytics/blob/main/images/monthly_trends.png)  

---

### 21. Average Transaction Amount by Month  
**Query:** Find monthly average transaction amount.  
![Monthly Avg](https://github.com/YourUsername/Bank_Analytics/blob/main/images/monthly_avg.png)  

---

### 22. Total Transaction Amount per Customer  
**Query:** Calculate spending per customer.  
![Customer Spending](https://github.com/YourUsername/Bank_Analytics/blob/main/images/customer_spending.png)  

---

### 23. Top 10 Merchants by Transaction Volume  
**Query:** Merchants with maximum transactions.  
![Top Merchants Volume](https://github.com/YourUsername/Bank_Analytics/blob/main/images/top_merchants_volume.png)  

---

### 24. Top 10 Merchants by Transaction Value  
**Query:** Merchants generating maximum revenue.  
![Top Merchants Value](https://github.com/YourUsername/Bank_Analytics/blob/main/images/top_merchants_value.png)  

---

### 25. Top 5 Customers by Transaction Amount  
**Query:** High-spending customers.  
![Top Spending Customers](https://github.com/YourUsername/Bank_Analytics/blob/main/images/top_spenders.png)  
